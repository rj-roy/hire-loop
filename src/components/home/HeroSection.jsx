...
export default function HeroSection() {
    ...
    return (
        <section className="relative min-h-screen bg-white dark:bg-black-bg overflow-hidden flex flex-col items-center pt-24 pb-20">
            ...
            <div className="relative z-10 w-full max-w-5xl mx-auto px-4 flex flex-col items-center">
                ...
                <div className="w-full max-w-3xl bg-gray-100 dark:bg-[#12121a] border border-gray-200 dark:border-gray-800 rounded-2xl p-1.5 flex items-center shadow-lg dark:shadow-2xl dark:shadow-indigo-500/5 mb-8">
                    ...
                    <button className="bg-indigo-600 hover:bg-indigo-700 text-white p-2.5 rounded-xl transition-colors flex-shrink-0 shadow-md shadow-indigo-500/20">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                    </button>
